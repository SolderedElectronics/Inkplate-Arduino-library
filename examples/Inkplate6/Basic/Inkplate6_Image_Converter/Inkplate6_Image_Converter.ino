 ...
 *              the screen. Expected output is your converted image displayed
 *              on the Inkplate 6 e-paper screen.
 *
 * Requirements:
 ...
 * 3) In Boards Manager -> Inkplate Boards, select "e-radionica Inkplate6" or "Soldered Inkplate6"
 *    from Tools -> Board.
