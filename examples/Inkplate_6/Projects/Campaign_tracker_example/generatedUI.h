...
int line0_start_x = 75;
int line0_start_y = 616;
int line0_end_x = 408;
int line0_end_y = 616;
int line0_color = BLACK;
int line0_thickness = 54;
int line0_gradient = 0;

String text11_content = "100%";
int text11_cursor_x = 245;
int text11_cursor_y = 565;
