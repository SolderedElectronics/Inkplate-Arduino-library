/*
   Inkplate_Battery_Voltage example for Soldered Inkplate 6Plus
...
void loop()
{
    float voltage = display.readBattery(); // Read battery voltage (NOTE: Doe to ESP32 ADC accuracy, you should calibrate the ADC!)
