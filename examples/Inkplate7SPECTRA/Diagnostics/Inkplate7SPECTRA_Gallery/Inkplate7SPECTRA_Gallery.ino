/*
    Inkplate7SPECTRA_Gallery example for Inkplate 7SPECTRA
    For this example you will need only USB cable and an Inkplate 7SPECTRA.
    ...
    This example will show you how you can use Inkplate 7SPECTRA to random images in the root sdcard folder.
