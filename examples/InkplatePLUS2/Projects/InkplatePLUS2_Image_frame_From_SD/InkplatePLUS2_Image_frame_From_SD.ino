/*
   InkplatePLUS2_Image_Frame_From_SD example for Soldered Inkplate PLUS2
   For this example you will need a USB-C cable, Inkplate PLUS2 and a SD card loaded with images.
