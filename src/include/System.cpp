...
// New Soldered Inkplate boards use P-MOS to disable supply to the uSD card to reduce power in deep sleep.
    ...
    defined(ARDUINO_INKPLATECOLOR) || defined(ARDUINO_INKPLATE5) || defined(ARDUINO_INKPLATE5V2) || defined(ARDUINO_INKPLATE4) ||                      \
    defined(ARDUINO_INKPLATE7) || defined(ARDUINO_INKPLATE4TEMPERA)
