/*
   Inkplate_6_FLICK_Calculator example for Soldered Inkplate 6 FLICK
   For this example you will need USB cable and Inkplate 6 FLICK (and a calculator, if you don't trust Inkplate :) ).
   Select "Soldered Inkplate 6 FLICK" from Tools -> Board menu.
   Don't "Soldered Inkplate 6 FLICK" option? Follow our tutorial and add it:
   https://soldered.com/learn/add-inkplate-6-board-definition-to-arduino-ide/

   This example will show you how simple GUI can be created on Inkplate 6 FLICK with this simple calculator example.
