/**
 **************************************************
 * @file        Inkplate13SPECTRA_RTC_Alarm.ino
 * @brief       RTC time and alarm example for Soldered Inkplate 13SPECTRA.
 *
 * @details     Shows how to use the basic alarm and clock functions of the
 *              PCF85063 RTC on the Inkplate board: how to set time and date, how
 *              to set an alarm, how to read the time and how to print the time on
 ...
 * 3) The sketch sets the time and date and configures the alarm.
 * 4) The current time is read and printed on the display.
 *
