 ...
 *
 *              The example runs in 1-bit (black & white) mode. Some custom fonts
 *              are drawn bottom-to-top and may require a vertical offset for
 *              correct positioning. Always call display.display() after drawing
 *              operations to update the physical e-paper screen. Expected result
 *              is two text boxes rendered on the screen: a default TextBox and a
 *              custom styled TextBox using the Roboto font.
 *
 * Requirements:
