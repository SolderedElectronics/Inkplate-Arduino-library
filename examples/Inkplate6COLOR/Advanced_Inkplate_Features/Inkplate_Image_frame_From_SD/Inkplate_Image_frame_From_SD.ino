/*
   Inkplate_Image_frame_From_SD example for Soldered Inkplate 6COLOR
   ...
   24 bit AND have resoluton smaller than 600s448 or otherwise it won't fit on screen.
    ...
    if (display.sdCardInit())
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if (!display.drawImage(pictureName, 0, 0, 1, 0))
                {
