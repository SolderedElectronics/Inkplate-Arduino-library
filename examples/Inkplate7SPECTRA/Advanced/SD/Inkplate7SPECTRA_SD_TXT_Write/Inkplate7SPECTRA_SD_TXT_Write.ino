/*
   Inkplate7SPECTRA_SD_TXT_Write example for Soldered Inkplate 7SPECTRA
...
char *fileName = "text.txt"; // The name of a file with the extension.

// The text you want to write in the file
char *dataToWrite = "Hello! This is the file writing example for Inkplate 7SPECTRA.\n"; // "\n" represents a new line
