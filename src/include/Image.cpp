 ...
 */
bool Image::drawImage(const String path, int x, int y, bool dither,
                      bool invert) {
 ...
 * @return      1 if succesfuly drawn, 0 if not
 */
bool Image::drawImage(const char *path, int x, int y, bool dither,
                      bool invert) {
 ...
 * @return      1 if succesfuly drawn, 0 if not
 */
bool Image::drawImage(const uint8_t *buf, int x, int y, int16_t w, int16_t h,
                      uint8_t c, uint8_t bg) {
 ...
 * @return      1 if succesfuly drawn, 0 if not
 */
bool Image::drawImage(const String path, const Format &format, const int x,
                      const int y, const bool dither, const bool invert) {
 ...
 * @return      1 if succesfuly drawn, 0 if not
 */
bool Image::drawImage(const char *path, const Format &format, const int x,
                      const int y, const bool dither, const bool invert) {
  if (strncmp(path, "http://", 7) == 0 || strncmp(path, "https://", 8) == 0) {
    if (format == BMP)
      return drawBitmapFromWeb(path, x, y, dither, invert);
 ...
 * @return      1 if succesfuly drawn, 0 if not
 */
bool Image::drawImage(const char *path, const Format &format,
 ...
 *              Image height
 */
void Image::drawBitmap3Bit(int16_t _x, int16_t _y, const unsigned char *_p,
