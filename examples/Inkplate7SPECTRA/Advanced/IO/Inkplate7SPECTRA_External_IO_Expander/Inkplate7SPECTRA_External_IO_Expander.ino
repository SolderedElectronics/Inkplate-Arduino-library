/*
   Inkplate7SPECTRA_External_IO_Expander example for Soldered Inkplate 7 SPECTRA
   For this example you will need only a micro USB cable, Inkplate 7 SPECTRA, 330 Ohm resistor and LED diode.
   Select "Soldered Inkplate 7 SPECTRA" from Tools -> Board menu.
   Don't have "Soldered Inkplate 7 SPECTRA" option? Follow our tutorial and add it:
