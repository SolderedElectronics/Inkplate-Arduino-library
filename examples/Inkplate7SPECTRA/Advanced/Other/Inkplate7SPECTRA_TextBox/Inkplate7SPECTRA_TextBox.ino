/*
   Inkplate 7SPECTRA example for Soldered Inkplate 7SPECTRA
   For this example you will need a micro USB cable and an Inkplate 7SPECTRA
...
void setup()
{
    ...
    display.drawTextBox(50,50,400,430,text,1);
    ...
    display.drawTextBox(450,50+offset,750,250,text,1,&Roboto_Light_36,27,false,36);
