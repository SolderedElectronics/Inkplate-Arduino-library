 ...
 * @brief       TRMNL BYOS client example for Soldered Inkplate 5v2.
 *
 * @details     Connects Inkplate 5v2 to WiFi, registers with a TRMNL-compatible
...
// WAKE button (same pin as the Inkplate5V2_Wake_Up_Button example): pressing
...
void doDisplay()
{
    ...
    http.addHeader("Model", "inkplate_5v2");
