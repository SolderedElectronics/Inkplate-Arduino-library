/*
    Inkplate4_Daily_Weather_Station example for Soldered Inkplate 4
    ...
    extract only temperature per day from JSON data and show it on Inkplate 4. 
