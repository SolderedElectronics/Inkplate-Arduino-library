/*
  Inkplate7SPECTRA_Peripheral_Mode example for Soldered Inkplate 7SPECTRA
  ...
  Instead, you can send UART command. This give you flexibility that you can use this Inkplate 7SPECTRA on any platform!
