/*
   Inkplate_Internal_IO_Expander example for e-radionica.com Inkplate 6
   ...
   You can only manipulate with Port B of IO Expander (GPB1-GPB7). Port A is used for epaper panel and TPS65186 PMIC.
