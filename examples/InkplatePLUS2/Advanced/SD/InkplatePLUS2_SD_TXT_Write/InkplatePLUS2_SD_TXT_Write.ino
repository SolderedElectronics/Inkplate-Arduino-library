/*
   InkplatePLUS2_SD_TXT_Write example for Soldered Inkplate PLUS2
   For this example you will need only a USB-C cable, Inkplate PLUS2 and a SD card.
...
char *dataToWrite = "Hello! This is the file writing example for Inkplate PLUS2.\n"; // "\n" represents a new line
