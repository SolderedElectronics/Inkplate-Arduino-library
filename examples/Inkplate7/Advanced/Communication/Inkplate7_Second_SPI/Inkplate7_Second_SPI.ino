/*
   Inkplate7_Second_SPI example for Soldered Inkplate 7
   For this example you will need a USB-C cable, Inkplate 7, MFRC522 RFID reader, RFID tag and few wires.
   ...
   24 April 2023 by Soldered Electronics.
*/
