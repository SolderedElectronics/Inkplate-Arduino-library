...
int text2_cursor_x = 225;
int text2_cursor_y = 531;
const GFXfont *text2_font = &Roboto_Light_36;
#define text2_font &Roboto_Light_36

String text3_content = "1";
int text3_cursor_x = 90;
int text3_cursor_y = 434;
const GFXfont *text3_font = &Roboto_Light_36;

String text4_content = "2";
int text4_cursor_x = 225;
int text4_cursor_y = 434;
const GFXfont *text4_font = &Roboto_Light_36;

String text5_content = "3";
int text5_cursor_x = 360;
int text5_cursor_y = 434;
const GFXfont *text5_font = &Roboto_Light_36;

String text6_content = "+";
int text6_cursor_x = 495;
int text6_cursor_y = 531;
const GFXfont *text6_font = &Roboto_Light_36;

String text7_content = "4";
int text7_cursor_x = 90;
int text7_cursor_y = 337;
const GFXfont *text7_font = &Roboto_Light_36;

String text8_content = "5";
int text8_cursor_x = 225;
int text8_cursor_y = 337;
const GFXfont *text8_font = &Roboto_Light_36;

String text9_content = "6";
int text9_cursor_x = 360;
int text9_cursor_y = 337;
const GFXfont *text9_font = &Roboto_Light_36;

String text10_content = "-";
int text10_cursor_x = 495;
int text10_cursor_y = 435;
const GFXfont *text10_font = &Roboto_Light_36;

String text11_content = "7";
int text11_cursor_x = 90;
int text11_cursor_y = 240;
const GFXfont *text11_font = &Roboto_Light_36;

String text12_content = "8";
int text12_cursor_x = 225;
int text12_cursor_y = 240;
const GFXfont *text12_font = &Roboto_Light_36;

String text13_content = "9";
int text13_cursor_x = 360;
int text13_cursor_y = 240;
const GFXfont *text13_font = &Roboto_Light_36;

String text14_content = "x";
int text14_cursor_x = 495;
int text14_cursor_y = 337;
const GFXfont *text14_font = &Roboto_Light_36;

String text15_content = "/";
int text15_cursor_x = 495;
int text15_cursor_y = 240;
const GFXfont *text15_font = &Roboto_Light_36;

String text16_content = "=";
int text16_cursor_x = 360;
int text16_cursor_y = 531;
const GFXfont *text16_font = &Roboto_Light_36;

String text17_content = ".";
int text17_cursor_x = 90;
int text17_cursor_y = 531;
const GFXfont *text17_font = &Roboto_Light_36;

String text18_content = "";
int text18_cursor_x = 550;
int text18_cursor_y = 144;
const GFXfont *text18_font = &FreeSansBold12pt7b;

String text19_content = "";
int text19_cursor_x = 240;
int text19_cursor_y = 81;
const GFXfont *text19_font = &FreeSansBold12pt7b;
...
int text20_cursor_x = 40;
int text20_cursor_y = 160;
const GFXfont *text20_font = &FreeSansBold12pt7b;
...
String text21_content = "Clear Input";
int text21_cursor_x = 40;
int text21_cursor_y = 110;
const GFXfont *text21_font = &FreeSansBold12pt7b;
...
String text22_content = "Clear result";
int text22_cursor_x = 40;
int text22_cursor_y = 60;
const GFXfont *text22_font = &FreeSansBold12pt7b;
...
void mainDraw()
{
    ...
    if (rect4_radius != -1 && rect4_fill != -1)
        display.fillRoundRect(rect4_a_x, rect4_a_y, rect4_b_x - rect4_a_x, rect4_b_y - rect4_a_y, rect4_radius,
                              rect4_color);
    else if (rect4_radius != -1 && rect4_fill == -1)
        display.drawRoundRect(rect4_a_x, rect4_a_y, rect4_b_x - rect4_a_x, rect4_b_y - rect4_a_y, rect4_radius,
                              rect4_color);
    else if (rect4_radius == -1 && rect4_fill != -1)
    ...
    if (rect8_radius != -1 && rect8_fill != -1)
        display.fillRoundRect(rect8_a_x, rect8_a_y, rect8_b_x - rect8_a_x, rect8_b_y - rect8_a_y, rect8_radius,
                              rect8_color);
    else if (rect8_radius != -1 && rect8_fill == -1)
        display.drawRoundRect(rect8_a_x, rect8_a_y, rect8_b_x - rect8_a_x, rect8_b_y - rect8_a_y, rect8_radius,
                              rect8_color);
    else if (rect8_radius == -1 && rect8_fill != -1)
    ...
    if (rect9_radius != -1 && rect9_fill != -1)
        display.fillRoundRect(rect9_a_x, rect9_a_y, rect9_b_x - rect9_a_x, rect9_b_y - rect9_a_y, rect9_radius,
                              rect9_color);
    else if (rect9_radius != -1 && rect9_fill == -1)
        display.drawRoundRect(rect9_a_x, rect9_a_y, rect9_b_x - rect9_a_x, rect9_b_y - rect9_a_y, rect9_radius,
                              rect9_color);
    else if (rect9_radius == -1 && rect9_fill != -1)
    ...
    if (rect10_radius != -1 && rect10_fill != -1)
        display.fillRoundRect(rect10_a_x, rect10_a_y, rect10_b_x - rect10_a_x, rect10_b_y - rect10_a_y, rect10_radius,
                              rect10_color);
    else if (rect10_radius != -1 && rect10_fill == -1)
        display.drawRoundRect(rect10_a_x, rect10_a_y, rect10_b_x - rect10_a_x, rect10_b_y - rect10_a_y, rect10_radius,
                              rect10_color);
    else if (rect10_radius == -1 && rect10_fill != -1)
    ...
    if (rect11_radius != -1 && rect11_fill != -1)
        display.fillRoundRect(rect11_a_x, rect11_a_y, rect11_b_x - rect11_a_x, rect11_b_y - rect11_a_y, rect11_radius,
                              rect11_color);
    else if (rect11_radius != -1 && rect11_fill == -1)
        display.drawRoundRect(rect11_a_x, rect11_a_y, rect11_b_x - rect11_a_x, rect11_b_y - rect11_a_y, rect11_radius,
                              rect11_color);
    else if (rect11_radius == -1 && rect11_fill != -1)
    ...
    if (rect12_radius != -1 && rect12_fill != -1)
        display.fillRoundRect(rect12_a_x, rect12_a_y, rect12_b_x - rect12_a_x, rect12_b_y - rect12_a_y, rect12_radius,
                              rect12_color);
    else if (rect12_radius != -1 && rect12_fill == -1)
        display.drawRoundRect(rect12_a_x, rect12_a_y, rect12_b_x - rect12_a_x, rect12_b_y - rect12_a_y, rect12_radius,
                              rect12_color);
    else if (rect12_radius == -1 && rect12_fill != -1)
    ...
    if (rect13_radius != -1 && rect13_fill != -1)
        display.fillRoundRect(rect13_a_x, rect13_a_y, rect13_b_x - rect13_a_x, rect13_b_y - rect13_a_y, rect13_radius,
                              rect13_color);
    else if (rect13_radius != -1 && rect13_fill == -1)
        display.drawRoundRect(rect13_a_x, rect13_a_y, rect13_b_x - rect13_a_x, rect13_b_y - rect13_a_y, rect13_radius,
                              rect13_color);
    else if (rect13_radius == -1 && rect13_fill != -1)
    ...
    if (rect14_radius != -1 && rect14_fill != -1)
        display.fillRoundRect(rect14_a_x, rect14_a_y, rect14_b_x - rect14_a_x, rect14_b_y - rect14_a_y, rect14_radius,
                              rect14_color);
    else if (rect14_radius != -1 && rect14_fill == -1)
        display.drawRoundRect(rect14_a_x, rect14_a_y, rect14_b_x - rect14_a_x, rect14_b_y - rect14_a_y, rect14_radius,
                              rect14_color);
    else if (rect14_radius == -1 && rect14_fill != -1)
    ...
    if (rect15_radius != -1 && rect15_fill != -1)
        display.fillRoundRect(rect15_a_x, rect15_a_y, rect15_b_x - rect15_a_x, rect15_b_y - rect15_a_y, rect15_radius,
                              rect15_color);
    else if (rect15_radius != -1 && rect15_fill == -1)
        display.drawRoundRect(rect15_a_x, rect15_a_y, rect15_b_x - rect15_a_x, rect15_b_y - rect15_a_y, rect15_radius,
                              rect15_color);
    else if (rect15_radius == -1 && rect15_fill != -1)
    ...
    if (rect16_radius != -1 && rect16_fill != -1)
        display.fillRoundRect(rect16_a_x, rect16_a_y, rect16_b_x - rect16_a_x, rect16_b_y - rect16_a_y, rect16_radius,
                              rect16_color);
    else if (rect16_radius != -1 && rect16_fill == -1)
        display.drawRoundRect(rect16_a_x, rect16_a_y, rect16_b_x - rect16_a_x, rect16_b_y - rect16_a_y, rect16_radius,
                              rect16_color);
    else if (rect16_radius == -1 && rect16_fill != -1)
    ...
    if (rect17_radius != -1 && rect17_fill != -1)
        display.fillRoundRect(rect17_a_x, rect17_a_y, rect17_b_x - rect17_a_x, rect17_b_y - rect17_a_y, rect17_radius,
                              rect17_color);
    else if (rect17_radius != -1 && rect17_fill == -1)
        display.drawRoundRect(rect17_a_x, rect17_a_y, rect17_b_x - rect17_a_x, rect17_b_y - rect17_a_y, rect17_radius,
                              rect17_color);
    else if (rect17_radius == -1 && rect17_fill != -1)
    ...
    if (rect18_radius != -1 && rect18_fill != -1)
        display.fillRoundRect(rect18_a_x, rect18_a_y, rect18_b_x - rect18_a_x, rect18_b_y - rect18_a_y, rect18_radius,
                              rect18_color);
    else if (rect18_radius != -1 && rect18_fill == -1)
        display.drawRoundRect(rect18_a_x, rect18_a_y, rect18_b_x - rect18_a_x, rect18_b_y - rect18_a_y, rect18_radius,
                              rect18_color);
    else if (rect18_radius == -1 && rect18_fill != -1)
    ...
    display.setTextColor(BLACK, WHITE);
    display.setTextSize(1);
    display.setCursor(text20_cursor_x, text20_cursor_y);
    display.print(text20_content);

    if (rect19_radius != -1 && rect19_fill != -1)
        display.fillRoundRect(rect19_a_x, rect19_a_y, rect19_b_x - rect19_a_x, rect19_b_y - rect19_a_y, rect19_radius,
                              rect19_color);
    else if (rect19_radius != -1 && rect19_fill == -1)
        display.drawRoundRect(rect19_a_x, rect19_a_y, rect19_b_x - rect19_a_x, rect19_b_y - rect19_a_y, rect19_radius,
                              rect19_color);
    else if (rect19_radius == -1 && rect19_fill != -1)
    ...
    display.setTextColor(BLACK, WHITE);
    display.setTextSize(1);
    display.setCursor(text21_cursor_x, text21_cursor_y);
    display.print(text21_content);

    if (rect20_radius != -1 && rect20_fill != -1)
        display.fillRoundRect(rect20_a_x, rect20_a_y, rect20_b_x - rect20_a_x, rect20_b_y - rect20_a_y, rect20_radius,
                              rect20_color);
    else if (rect20_radius != -1 && rect20_fill == -1)
        display.drawRoundRect(rect20_a_x, rect20_a_y, rect20_b_x - rect20_a_x, rect20_b_y - rect20_a_y, rect20_radius,
                              rect20_color);
    else if (rect20_radius == -1 && rect20_fill != -1)
    ...
    display.setTextColor(BLACK, WHITE);
    display.setTextSize(1);
    display.setCursor(text22_cursor_x, text22_cursor_y);
