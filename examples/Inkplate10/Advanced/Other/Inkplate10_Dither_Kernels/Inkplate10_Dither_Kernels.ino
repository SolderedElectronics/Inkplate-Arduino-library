/**
 **************************************************
 * @file        Inkplate10_Dither_Kernels.ino
 * @brief       Switch dithering kernels when drawing an image on Soldered Inkplate10.
 *
 ...
 *              limited grayscale palette is spread to neighboring pixels -
 *              different kernels trade off sharpness, noise and speed.
 *
 *              Available kernels (Image::DitherKernel enum):
 ...
 *              ReducedDiffusion  - minimal diffusion, faster/coarser
 *
 ...
 *
 * Requirements:
 * - Board:      Soldered Inkplate10
 * - Hardware:   Inkplate10, USB cable, microSD card
 ...
 * 3) Upload the sketch to Inkplate10.
...
Image::DitherKernel kernels[] = {
    Image::FloydSteinberg, Image::JarvisJudiceNinke, Image::Atkinson,     Image::Burkes,
    Image::Stucki,         Image::SierraLite,        Image::ReducedDiffusion,
};
