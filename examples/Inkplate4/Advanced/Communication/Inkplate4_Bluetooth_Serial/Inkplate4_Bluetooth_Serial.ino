/*
   Inkplate4_Bluetooth_Serial example for Soldered Inkplate 4
   For this example you will need a USB-C cable, Inkplate 4 and smartphone.
...
const char *btDeviceName = "Inkplate4";
...
void setup()
{
    ...
    display.println("Bluetooth Serial\nExample\n");
    display.setTextSize(2);
    display.println("Open the Serial Monitor at 115200baud to see sent messages");
