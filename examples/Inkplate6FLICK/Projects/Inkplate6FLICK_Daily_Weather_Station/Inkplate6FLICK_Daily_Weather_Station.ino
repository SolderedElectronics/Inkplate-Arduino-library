/*
    Inkplate6FLICK_Daily_Weather_Station example for Soldered Inkplate 6FLICK
...
void setup()
{
    ...
    network.getData(lat, lon, apiKey, city, temps[0], temps[1], temps[2], temps[3], currentTemp, currentWind, currentTime,
