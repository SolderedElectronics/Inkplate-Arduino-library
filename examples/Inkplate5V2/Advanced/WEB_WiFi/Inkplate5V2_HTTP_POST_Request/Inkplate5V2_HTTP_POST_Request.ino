/*
   Inkplate5V2_HTTP_POST_Request example for Soldered Inkplate5
   For this example you will need a USB-C cable, Inkplate5 and stable WiFi Internet connection.
