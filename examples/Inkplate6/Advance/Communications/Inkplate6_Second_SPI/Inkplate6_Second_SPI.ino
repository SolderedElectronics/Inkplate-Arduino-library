/*
   Inkplate6_Second_SPI example for Soldered Inkplate 6
   For this example you will need a USB-C cable, Inkplate6, MFRC522 RFID reader, RFID tag and few wires.
   ...
   NOTE: you have to cut JP4 and connect the other 2 contacts in order to work!
