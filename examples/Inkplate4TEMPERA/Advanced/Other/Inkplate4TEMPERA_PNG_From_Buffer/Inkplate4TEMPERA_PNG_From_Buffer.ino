 ...
 *              free heap). PNG resolution should not exceed 600 x 600 pixels.
 ...
 *
 * How to use:
 * 1) In Boards Manager -> Inkplate Boards, select "Inkplate 4 TEMPERA"
 *    from Tools -> Board.
 * 2) Copy a PNG file named "image.png" to a FAT-formatted SD card.
 * 3) Insert the SD card into the Inkplate.
 * 4) Upload the sketch to Inkplate 4 TEMPERA.
