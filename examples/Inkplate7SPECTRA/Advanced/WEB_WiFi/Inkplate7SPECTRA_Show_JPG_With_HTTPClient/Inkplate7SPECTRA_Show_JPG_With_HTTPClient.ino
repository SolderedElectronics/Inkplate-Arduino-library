/*
  Inkplate7SPECTRA_Show_JPG_With_HTTPClient example for Soldered Inkplate 7SPECTRA
  For this example you will need a USB-C cable, Inkplate 7SPECTRA, and an available WiFi connection.
