/**
 **************************************************
 * @file        Inkplate13SPECTRA_Qwiic.ino
 * @brief       Read a BME680 sensor over Qwiic (I2C) on Soldered Inkplate 13SPECTRA.
 *
 * @details     Shows how to read temperature, humidity and air pressure data
 *              from a BME680 sensor connected to the Inkplate Qwiic connector.
 ...
 *               BME680 sensor with Qwiic connector
 ...
 * 3) Connect the BME680 breakout to the Inkplate Qwiic connector.
