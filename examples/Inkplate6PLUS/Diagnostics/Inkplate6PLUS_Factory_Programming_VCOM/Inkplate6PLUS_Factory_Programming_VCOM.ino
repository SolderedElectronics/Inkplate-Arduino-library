 ...
 *
 * @details     Inkplate 6PLUS does not support auto VCOM, it has to be set
 ...
 * - Hardware:   Inkplate 6PLUS, USB cable, formatted microSD card,
 ...
 * 3) Insert a formatted microSD card and upload the sketch to Inkplate 6PLUS.
