/*
   Inkplate6FLICK_Second_SPI example for Soldered Inkplate 6FLICK
   For this example you will need a USB-C cable, Inkplate 6FLICK, MFRC522 RFID reader, RFID tag and few wires.
