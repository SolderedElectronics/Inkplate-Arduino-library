/*
  Inkplate7SPECTRA_Bluetooth_Serial example for Soldered Inkplate 7SPECTRA
  For this example you will need USB cable, Inkplate 7SPECTRA and smartphone.
  Select "Soldered Inkplate 7SPECTRA" from Tools -> Board menu.
  Don't have "Inkplate 7SPECTRA" or "Soldered Inkplate 7SPECTRA" option? Follow our tutorial and add it:
...
void setup()
{
  ...
  inkplate.setTextSize(3);                 // Scale text to be 3 times bigger then original (5x7 px)
  ...
  BLEDevice::init("Inkplate 7SPECTRA");
