/*
  Inkplate7SPECTRA_HTTP_Request example for Soldered Inkplate 7SPECTRA
  For this example you will need USB cable, Inkplate 7SPECTRA and stable WiFi Internet connection
...
void setup()
{
  ...
  inkplate.setTextSize(3);                          // Set text scaling to three (text will be three times bigger)
