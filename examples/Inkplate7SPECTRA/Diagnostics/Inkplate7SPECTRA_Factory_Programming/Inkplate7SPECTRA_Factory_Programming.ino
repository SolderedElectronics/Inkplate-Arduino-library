 ...
 *              - Connect a slave device via Qwiic on address 0x76 (you may change this in test.cpp also).
 *                In the InkplateQwiicTester folder, you can find the code for uploading to Dasduino Core 
 *                or Dasduino ConnectPlus to convert Dasduino to an I2C slave device for testing a Qwiic connector
