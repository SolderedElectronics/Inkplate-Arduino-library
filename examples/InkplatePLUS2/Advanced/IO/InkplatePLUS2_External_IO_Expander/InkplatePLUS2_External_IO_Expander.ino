/*
   InkplatePLUS2_External_IO_Expander example for Soldered Inkplate PLUS2
   For this example you will need only a USB-C cable, Inkplate PLUS2, 330 Ohm resistor and LED diode.
