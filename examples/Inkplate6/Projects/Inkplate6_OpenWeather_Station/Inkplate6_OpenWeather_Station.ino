/*
   Inkplate6_OpenWeather_Station example for Soldered Inkplate 6
...
void setup()
{
    ...
    // If the Inkplate isn't able to connect to a network stop further code execution and print an error messddage.
...
void drawForecast()
{
    ...
    for (int day = startDay; day < 4; day++)
    {
        ...
        display.drawImage(Output, dayPos + 92, dayOffset, true, true);
