/*
   Inkplate5_Crowdsupply_Campaing_Tracker example for Soldered Inkplate 5
   For this example you will need only USB cable and Inkplate 5.
   Select "Soldered Inkplate5" from Tools -> Board menu.
   Don't have "Soldered Inkplate5" option? Follow our tutorial and add it:
   https://soldered.com/learn/add-inkplate-5-board-definition-to-arduino-ide/

   This example will show you how you can use Inkplate 5 to display html data.
...
#define URL      "https://www.crowdsupply.com/soldered/inkplate-5" // Link to the Inkplate 5 crowdsupply campaign
