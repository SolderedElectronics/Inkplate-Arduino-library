/*
    Inkplate7_Youtube_Subscriber_Counter example for Soldered Inkplate 7
...
textElement elements[] = {
    {19, 41, &Inter30pt7b, channel.name, 0, INKPLATE7_BLACK},
    {20, 42, &Inter30pt7b, channel.name, 0, INKPLATE7_RED},
    {210, 180, &Inter30pt7b, (char *)NULL, 0, INKPLATE7_BLACK},
    {210, 180, &Inter12pt7b, "Subscribers:", 1, INKPLATE7_BLACK},
    {210, 250, &Inter30pt7b, (char *)NULL, 0, INKPLATE7_BLACK},
    {210, 250, &Inter12pt7b, "Views:", 1, INKPLATE7_BLACK},
    {210, 320, &Inter30pt7b, (char *)NULL, 0, INKPLATE7_BLACK},
    {210, 320, &Inter12pt7b, "Videos:", 1, INKPLATE7_BLACK},
};
...
void setup()
{
    ...
    {
        // Welcome screen
        display.drawImage(youtube_icon, 218, 150, 204, 84); // Draw the YouTube logo
        display.setCursor(178, 244); // Set cursor, custom font uses different method for setting cursor
...
void drawAll()
{
    ...
    {
        // Text settings
        display.setTextColor(elements[i].text_color, INKPLATE7_WHITE);
