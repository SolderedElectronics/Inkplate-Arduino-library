...
void drawNews(struct news *entities)
{
    ...
    while (coll < 3)
    {
        display.setCursor(10 + 274 * coll, y);
        ...
        {
            if (display.getCursorX() > 274 * coll + 230 || (*(entities[i].description + cnt) == ' ' && display.getCursorX() > 274 * coll + 210))
            {
