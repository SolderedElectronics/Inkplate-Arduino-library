...
/**
 **************************************************
 * @file        Inkplate6_Bluetooth_Serial.ino
 * @brief       Bluetooth SPP serial bridge example for Soldered Inkplate 6.
 *
 * @details     Demonstrates how to use classic Bluetooth (SPP profile) on the
 *              Inkplate 6 to exchange text data between the board and a
