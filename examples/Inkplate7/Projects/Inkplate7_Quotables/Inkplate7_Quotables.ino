/*
    Inkplate7_Quotables example for Soldered Inkplate 7
    For this example you will need only USB cable, Inkplate 7 and a WiFi with stable Internet connection.
    ...
    we extract only quote from JSON data and show it on Inkplate 7. After displaying quote
