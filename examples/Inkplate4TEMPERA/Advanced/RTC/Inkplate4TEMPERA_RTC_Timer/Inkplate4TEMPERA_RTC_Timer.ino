 ...
 *              shows how to set time and date, configure the RTC timer, read
 *              current time values, and display them on the e-paper screen using
 *              partial updates.
 *
 ...
 *              is the current date and time on the Inkplate display, with the
 *              timer operating according to the configured interval.
 *
 * Requirements:
