/*
   Inkplate4TEMPERA_Hourly_Weather_Station example for Soldered Inkplate 4 TEMPERA
   ...
   per hour from JSON data and show it on Inkplate 4TEMPERA. After displaying the weather,
