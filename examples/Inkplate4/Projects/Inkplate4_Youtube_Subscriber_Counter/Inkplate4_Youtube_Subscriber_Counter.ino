/*
    Inkplate4_Youtube_Subscriber_Counter example for Soldered Inkplate 4
...
textElement elements[] = {
    {20, 40, &FreeSans18pt7b, channel.name, 0, INKPLATE4_BLACK},
    {20, 42, &FreeSans18pt7b, channel.name, 0, INKPLATE4_RED},
    {225, 150, &Inter12pt7b, (char *)NULL, 0, INKPLATE4_BLACK},
    {220, 150, &Inter12pt7b, "Subscribers:", 1, INKPLATE4_BLACK},
    {225, 180, &Inter12pt7b, (char *)NULL, 0, INKPLATE4_BLACK},
    {220, 180, &Inter12pt7b, "Views:", 1, INKPLATE4_BLACK},
    {225, 208, &Inter12pt7b, (char *)NULL, 0, INKPLATE4_BLACK},
    {220, 208, &Inter12pt7b, "Videos:", 1, INKPLATE4_BLACK},
};
...
void setup()
{
    ...
    {
        // Welcome screen
        display.drawImage(youtube_icon, 98, 93, 204, 84); // Draw the YouTube logo
        display.setCursor(35, 182); // Set cursor, custom font uses different method for setting cursor
...
void drawAll()
{
    ...
    {
        // Text settings
        display.setTextColor(elements[i].text_color, INKPLATE4_WHITE);
