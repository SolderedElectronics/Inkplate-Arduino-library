/**
 **************************************************
 * @file        Inkplate7SPECTRA_Dither_Kernels.ino
 * @brief       Switch dithering kernels when drawing an image on Soldered Inkplate 7SPECTRA.
 *
 ...
 * - Hardware:   Inkplate 7SPECTRA, USB cable, SD card
 * - Extra:      SD card with a file named "picture1.jpg"
 * - SD card:    FAT / FAT32 format
 *
 * How to use:
 * 1) In Boards Manager -> Inkplate Boards, select "Soldered Inkplate 7SPECTRA"
 *    from Tools -> Board.
 * 2) Copy picture1.jpg to a FAT-formatted SD card and insert it into the Inkplate.
 * 3) Upload the sketch to Inkplate 7SPECTRA.
