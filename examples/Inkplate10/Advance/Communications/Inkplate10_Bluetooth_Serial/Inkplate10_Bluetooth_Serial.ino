/*
   Inkplate10_Bluetooth_Serial example for Soldered Inkplate10
   For this example you will need USB cable, Inkplate 10 and smartphone.
...
const char *btDeviceName = "Inkplate 10";
