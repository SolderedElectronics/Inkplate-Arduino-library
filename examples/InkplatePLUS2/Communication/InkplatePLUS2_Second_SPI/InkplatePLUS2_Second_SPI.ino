/*
   InkplatePLUS2_Second_SPI example for Soldered Inkplate PLUS2
   For this example you will need a USB-C cable, Inkplate PLUS2, MFRC522 RFID reader, RFID tag and few wires.
   ...
   25 April 2023 by Soldered Electronics.
*/
...
void setup()
{
    ...
    display.print("Second SPI example");

    // Print other text on the display
    display.setTextSize(2);
    display.setCursor(30, 70);
    display.println("Open the Serial Monitor at 115200 baud rate");
    display.setCursor(30, 90);
    display.println("to see what's happening!");
